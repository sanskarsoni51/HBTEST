...
const Foter = () => {
  return (
    <footer className="bg-lbrown text-center text-pale  lg:text-left">
        ...
        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            ...
            <p>
              ...
              perfect for every occasion, from weddings to daily wear.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mb-4 flex items-center justify-center md:justify-start">
              ...
              Swastik Complex, Near Nagar Palika Bhinder, Udaipur
            </p>
            <p className="mb-4 flex items-center justify-center md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="bg-brown p-6 text-center ">
        <span>© 2024 Copyright:</span>
        <a className="font-semibold text-pale " href="https://tw-elements.com/">
          The Haat Bazaar
        </a>
      </div>
    </footer>
